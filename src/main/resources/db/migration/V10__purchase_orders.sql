...
CREATE INDEX idx_purchase_orders_code ON purchase_orders(purchase_order_code);
CREATE UNIQUE INDEX uq_purchase_order_code ON purchase_orders(purchase_order_code) WHERE purchase_order_code IS NOT NULL;
