-- V17: Make audit_logs.user_id nullable and update FK to ON DELETE SET NULL
-- Also update audit trigger to set actor_id NULL when session var missing

-- 1) Allow NULL user_id in audit_logs
ALTER TABLE audit_logs
  ALTER COLUMN user_id DROP NOT NULL;

-- 2) Recreate FK constraint with ON DELETE SET NULL
ALTER TABLE audit_logs
...
-- 3) Update trigger function: actor_id is NULL when session var not set
